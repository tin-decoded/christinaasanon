        ...
        <div className="flex flex-col space-y-10">
          {data.map((entry, index) => (
            <div key={index} className="flex items-start gap-6">
              {/* Year */}
              <div className="w-16 shrink-0 text-left text-2xl sm:text-2xl md:text-2xl lg:text-3xl font-light text-zinc-300">
                {entry.year}
              </div>
                  ...
                  return (
                    <div key={idx} className="relative">
                      ...
                      <div className="absolute -left-2 top-0 bottom-0">
                        ...
                        <div
                          className={`absolute left-0 top-2 -bottom-12 w-px ${
